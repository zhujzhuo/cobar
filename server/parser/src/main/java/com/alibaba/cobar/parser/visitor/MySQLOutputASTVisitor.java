...
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_FALSE;
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_NOT_FALSE;
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_NOT_NULL;
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_NOT_TRUE;
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_NOT_UNKNOWN;
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_NULL;
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_TRUE;
import static com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression.IS_UNKNOWN;

import java.util.List;
import java.util.Map;

import com.alibaba.cobar.parser.ASTNode;
import com.alibaba.cobar.parser.expression.BinaryOperatorExpression;
import com.alibaba.cobar.parser.expression.Expression;
import com.alibaba.cobar.parser.expression.PolyadicOperatorExpression;
import com.alibaba.cobar.parser.expression.TernaryOperatorExpression;
import com.alibaba.cobar.parser.expression.UnaryOperatorExpression;
...
import com.alibaba.cobar.parser.expression.primary.VariableExpression;
...
import com.alibaba.cobar.parser.fragment.ddl.ColumnDefinition;
import com.alibaba.cobar.parser.fragment.ddl.TableOptions;
import com.alibaba.cobar.parser.fragment.ddl.datatype.DataType;
import com.alibaba.cobar.parser.fragment.ddl.index.IndexColumnName;
import com.alibaba.cobar.parser.fragment.ddl.index.IndexOption;
...
import com.alibaba.cobar.parser.statement.dal.ShowAuthors;
import com.alibaba.cobar.parser.statement.dal.ShowBinLogEvent;
import com.alibaba.cobar.parser.statement.dal.ShowBinaryLog;
import com.alibaba.cobar.parser.statement.dal.ShowCharaterSet;
import com.alibaba.cobar.parser.statement.dal.ShowCollation;
import com.alibaba.cobar.parser.statement.dal.ShowColumns;
import com.alibaba.cobar.parser.statement.dal.ShowContributors;
import com.alibaba.cobar.parser.statement.dal.ShowCreate;
import com.alibaba.cobar.parser.statement.dal.ShowDatabases;
import com.alibaba.cobar.parser.statement.dal.ShowEngine;
import com.alibaba.cobar.parser.statement.dal.ShowEngines;
import com.alibaba.cobar.parser.statement.dal.ShowErrors;
import com.alibaba.cobar.parser.statement.dal.ShowEvents;
import com.alibaba.cobar.parser.statement.dal.ShowFunctionCode;
import com.alibaba.cobar.parser.statement.dal.ShowFunctionStatus;
import com.alibaba.cobar.parser.statement.dal.ShowGrants;
import com.alibaba.cobar.parser.statement.dal.ShowIndex;
import com.alibaba.cobar.parser.statement.dal.ShowMasterStatus;
import com.alibaba.cobar.parser.statement.dal.ShowOpenTables;
import com.alibaba.cobar.parser.statement.dal.ShowPlugins;
import com.alibaba.cobar.parser.statement.dal.ShowPrivileges;
import com.alibaba.cobar.parser.statement.dal.ShowProcedureCode;
import com.alibaba.cobar.parser.statement.dal.ShowProcedureStatus;
import com.alibaba.cobar.parser.statement.dal.ShowProcesslist;
import com.alibaba.cobar.parser.statement.dal.ShowProfile;
import com.alibaba.cobar.parser.statement.dal.ShowProfiles;
import com.alibaba.cobar.parser.statement.dal.ShowSlaveHosts;
import com.alibaba.cobar.parser.statement.dal.ShowSlaveStatus;
import com.alibaba.cobar.parser.statement.dal.ShowStatus;
import com.alibaba.cobar.parser.statement.dal.ShowTableStatus;
import com.alibaba.cobar.parser.statement.dal.ShowTables;
import com.alibaba.cobar.parser.statement.dal.ShowTriggers;
import com.alibaba.cobar.parser.statement.dal.ShowVariables;
import com.alibaba.cobar.parser.statement.dal.ShowWarnings;
import com.alibaba.cobar.parser.statement.ddl.DDLAlterTableStatement;
import com.alibaba.cobar.parser.statement.ddl.DDLCreateIndexStatement;
import com.alibaba.cobar.parser.statement.ddl.DDLCreateTableStatement;
import com.alibaba.cobar.parser.statement.ddl.DDLDropIndexStatement;
import com.alibaba.cobar.parser.statement.ddl.DDLDropTableStatement;
import com.alibaba.cobar.parser.statement.ddl.DDLRenameTableStatement;
...
import com.alibaba.cobar.parser.statement.ddl.DDLAlterTableStatement.AlterSpecification;
...
import com.alibaba.cobar.parser.statement.extension.ExtDDLCreatePolicy;
import com.alibaba.cobar.parser.statement.extension.ExtDDLDropPolicy;
