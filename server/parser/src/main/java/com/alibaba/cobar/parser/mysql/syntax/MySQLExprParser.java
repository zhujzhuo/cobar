...
import static com.alibaba.cobar.parser.mysql.MySQLToken.EOF;
import static com.alibaba.cobar.parser.mysql.MySQLToken.IDENTIFIER;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_AND;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_AS;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_ASC;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_BY;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_COLLATE;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_DESC;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_DISTINCT;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_FROM;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_IN;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_INTEGER;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_LIKE;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_NOT;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_SELECT;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_SEPARATOR;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_THEN;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_USING;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_WHEN;
import static com.alibaba.cobar.parser.mysql.MySQLToken.KW_WITH;
import static com.alibaba.cobar.parser.mysql.MySQLToken.LITERAL_CHARS;
import static com.alibaba.cobar.parser.mysql.MySQLToken.OP_ASSIGN;
import static com.alibaba.cobar.parser.mysql.MySQLToken.PUNC_COMMA;
import static com.alibaba.cobar.parser.mysql.MySQLToken.PUNC_DOT;
...
import static com.alibaba.cobar.parser.mysql.MySQLToken.USR_VAR;
...
import com.alibaba.cobar.parser.expression.arithmeic.ArithmeticAddExpression;
import com.alibaba.cobar.parser.expression.arithmeic.ArithmeticDivideExpression;
import com.alibaba.cobar.parser.expression.arithmeic.ArithmeticIntegerDivideExpression;
import com.alibaba.cobar.parser.expression.arithmeic.ArithmeticModExpression;
import com.alibaba.cobar.parser.expression.arithmeic.ArithmeticMultiplyExpression;
import com.alibaba.cobar.parser.expression.arithmeic.ArithmeticSubtractExpression;
import com.alibaba.cobar.parser.expression.arithmeic.MinusExpression;
import com.alibaba.cobar.parser.expression.bit.BitAndExpression;
import com.alibaba.cobar.parser.expression.bit.BitInvertExpression;
import com.alibaba.cobar.parser.expression.bit.BitOrExpression;
import com.alibaba.cobar.parser.expression.bit.BitShiftExpression;
import com.alibaba.cobar.parser.expression.bit.BitXORExpression;
import com.alibaba.cobar.parser.expression.comparison.BetweenAndExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionEqualsExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionGreaterThanExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionGreaterThanOrEqualsExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionIsExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionLessOrGreaterThanExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionLessThanExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionLessThanOrEqualsExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionNotEqualsExpression;
import com.alibaba.cobar.parser.expression.comparison.ComparisionNullSafeEqualsExpression;
import com.alibaba.cobar.parser.expression.comparison.InExpression;
import com.alibaba.cobar.parser.expression.logical.LogicalAndExpression;
import com.alibaba.cobar.parser.expression.logical.LogicalNotExpression;
import com.alibaba.cobar.parser.expression.logical.LogicalOrExpression;
import com.alibaba.cobar.parser.expression.logical.LogicalXORExpression;
import com.alibaba.cobar.parser.expression.logical.NegativeValueExpression;
import com.alibaba.cobar.parser.expression.misc.AssignmentExpression;
...
import com.alibaba.cobar.parser.expression.misc.SubqueryAllExpression;
import com.alibaba.cobar.parser.expression.misc.SubqueryAnyExpression;
import com.alibaba.cobar.parser.expression.misc.UserExpression;
import com.alibaba.cobar.parser.expression.primary.CaseWhenOperatorExpression;
import com.alibaba.cobar.parser.expression.primary.DefaultValue;
import com.alibaba.cobar.parser.expression.primary.ExistsPrimary;
import com.alibaba.cobar.parser.expression.primary.Identifier;
import com.alibaba.cobar.parser.expression.primary.MatchExpression;
import com.alibaba.cobar.parser.expression.primary.RowExpression;
import com.alibaba.cobar.parser.expression.primary.UsrDefVarPrimary;
import com.alibaba.cobar.parser.expression.primary.Wildcard;
import com.alibaba.cobar.parser.expression.primary.MatchExpression.Modifier;
import com.alibaba.cobar.parser.expression.primary.function.FunctionExpression;
import com.alibaba.cobar.parser.expression.primary.function.cast.Cast;
import com.alibaba.cobar.parser.expression.primary.function.cast.Convert;
...
import com.alibaba.cobar.parser.expression.primary.function.datetime.Extract;
import com.alibaba.cobar.parser.expression.primary.function.datetime.GetFormat;
import com.alibaba.cobar.parser.expression.primary.function.datetime.Now;
import com.alibaba.cobar.parser.expression.primary.function.datetime.Timestampadd;
import com.alibaba.cobar.parser.expression.primary.function.datetime.Timestampdiff;
...
import com.alibaba.cobar.parser.expression.primary.function.groupby.Avg;
import com.alibaba.cobar.parser.expression.primary.function.groupby.Count;
import com.alibaba.cobar.parser.expression.primary.function.groupby.GroupConcat;
import com.alibaba.cobar.parser.expression.primary.function.groupby.Max;
import com.alibaba.cobar.parser.expression.primary.function.groupby.Min;
import com.alibaba.cobar.parser.expression.primary.function.groupby.Sum;
import com.alibaba.cobar.parser.expression.primary.function.info.CurrentUser;
import com.alibaba.cobar.parser.expression.primary.function.string.Char;
...
import com.alibaba.cobar.parser.expression.primary.function.string.Trim;
import com.alibaba.cobar.parser.expression.primary.function.string.Trim.Direction;
import com.alibaba.cobar.parser.expression.primary.literal.IntervalPrimary;
import com.alibaba.cobar.parser.expression.primary.literal.LiteralBitField;
import com.alibaba.cobar.parser.expression.primary.literal.LiteralBoolean;
import com.alibaba.cobar.parser.expression.primary.literal.LiteralHexadecimal;
import com.alibaba.cobar.parser.expression.primary.literal.LiteralNull;
import com.alibaba.cobar.parser.expression.primary.literal.LiteralNumber;
import com.alibaba.cobar.parser.expression.primary.literal.LiteralString;
import com.alibaba.cobar.parser.expression.string.LikeExpression;
import com.alibaba.cobar.parser.expression.string.RegexpExpression;
import com.alibaba.cobar.parser.expression.string.SoundsLikeExpression;
import com.alibaba.cobar.parser.expression.type.CastBinaryExpression;
import com.alibaba.cobar.parser.expression.type.CollateExpression;
