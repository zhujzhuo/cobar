 ...
 * (created at 2011-6-1)
 */
package com.alibaba.cobar.server.parser.visitor;

import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_FALSE;
import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_FALSE;
import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_NULL;
import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_TRUE;
import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_UNKNOWN;
import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_NULL;
import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_TRUE;
import static com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression.IS_UNKNOWN;
...
import com.alibaba.cobar.server.parser.ast.expression.PolyadicOperatorExpression;
import com.alibaba.cobar.server.parser.ast.expression.TernaryOperatorExpression;
import com.alibaba.cobar.server.parser.ast.expression.UnaryOperatorExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.BetweenAndExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionEqualsExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionNullSafeEqualsExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.InExpression;
import com.alibaba.cobar.server.parser.ast.expression.logical.LogicalAndExpression;
import com.alibaba.cobar.server.parser.ast.expression.logical.LogicalOrExpression;
import com.alibaba.cobar.server.parser.ast.expression.misc.InExpressionList;
import com.alibaba.cobar.server.parser.ast.expression.misc.QueryExpression;
import com.alibaba.cobar.server.parser.ast.expression.misc.UserExpression;
import com.alibaba.cobar.server.parser.ast.expression.primary.CaseWhenOperatorExpression;
import com.alibaba.cobar.server.parser.ast.expression.primary.DefaultValue;
...
import com.alibaba.cobar.server.parser.ast.expression.primary.ParamMarker;
import com.alibaba.cobar.server.parser.ast.expression.primary.PlaceHolder;
import com.alibaba.cobar.server.parser.ast.expression.primary.RowExpression;
import com.alibaba.cobar.server.parser.ast.expression.primary.SysVarPrimary;
import com.alibaba.cobar.server.parser.ast.expression.primary.UsrDefVarPrimary;
import com.alibaba.cobar.server.parser.ast.expression.primary.VariableExpression;
...
import com.alibaba.cobar.server.parser.ast.expression.primary.function.datetime.Extract;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.datetime.GetFormat;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.datetime.Timestampadd;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.datetime.Timestampdiff;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.groupby.Avg;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.groupby.Count;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.groupby.GroupConcat;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.groupby.Max;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.groupby.Min;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.groupby.Sum;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.string.Char;
import com.alibaba.cobar.server.parser.ast.expression.primary.function.string.Trim;
import com.alibaba.cobar.server.parser.ast.expression.primary.literal.IntervalPrimary;
import com.alibaba.cobar.server.parser.ast.expression.primary.literal.LiteralBitField;
import com.alibaba.cobar.server.parser.ast.expression.primary.literal.LiteralBoolean;
import com.alibaba.cobar.server.parser.ast.expression.primary.literal.LiteralHexadecimal;
import com.alibaba.cobar.server.parser.ast.expression.primary.literal.LiteralNull;
import com.alibaba.cobar.server.parser.ast.expression.primary.literal.LiteralNumber;
import com.alibaba.cobar.server.parser.ast.expression.primary.literal.LiteralString;
import com.alibaba.cobar.server.parser.ast.expression.string.LikeExpression;
import com.alibaba.cobar.server.parser.ast.expression.type.CollateExpression;
import com.alibaba.cobar.server.parser.ast.fragment.GroupBy;
import com.alibaba.cobar.server.parser.ast.fragment.Limit;
import com.alibaba.cobar.server.parser.ast.fragment.OrderBy;
import com.alibaba.cobar.server.parser.ast.fragment.SortOrder;
import com.alibaba.cobar.server.parser.ast.fragment.VariableScope;
import com.alibaba.cobar.server.parser.ast.fragment.ddl.ColumnDefinition;
import com.alibaba.cobar.server.parser.ast.fragment.ddl.TableOptions;
import com.alibaba.cobar.server.parser.ast.fragment.ddl.datatype.DataType;
import com.alibaba.cobar.server.parser.ast.fragment.ddl.index.IndexColumnName;
import com.alibaba.cobar.server.parser.ast.fragment.ddl.index.IndexOption;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.Dual;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.IndexHint;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.InnerJoin;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.NaturalJoin;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.OuterJoin;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.StraightJoin;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.SubqueryFactor;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.TableRefFactor;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.TableReference;
import com.alibaba.cobar.server.parser.ast.fragment.tableref.TableReferences;
import com.alibaba.cobar.server.parser.ast.statement.dal.DALSetCharacterSetStatement;
import com.alibaba.cobar.server.parser.ast.statement.dal.DALSetNamesStatement;
import com.alibaba.cobar.server.parser.ast.statement.dal.DALSetStatement;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowAuthors;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowBinLogEvent;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowBinaryLog;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowCharaterSet;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowCollation;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowColumns;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowContributors;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowCreate;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowDatabases;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowEngine;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowEngines;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowErrors;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowEvents;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowFunctionCode;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowFunctionStatus;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowGrants;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowIndex;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowMasterStatus;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowOpenTables;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowPlugins;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowPrivileges;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowProcedureCode;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowProcedureStatus;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowProcesslist;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowProfile;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowProfiles;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowSlaveHosts;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowSlaveStatus;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowStatus;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowTableStatus;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowTables;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowTriggers;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowVariables;
import com.alibaba.cobar.server.parser.ast.statement.dal.ShowWarnings;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLAlterTableStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLCreateIndexStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLCreateTableStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLDropIndexStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLDropTableStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLRenameTableStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLTruncateStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DescTableStatement;
import com.alibaba.cobar.server.parser.ast.statement.ddl.DDLAlterTableStatement.AlterSpecification;
import com.alibaba.cobar.server.parser.ast.statement.dml.DMLCallStatement;
import com.alibaba.cobar.server.parser.ast.statement.dml.DMLDeleteStatement;
import com.alibaba.cobar.server.parser.ast.statement.dml.DMLInsertStatement;
import com.alibaba.cobar.server.parser.ast.statement.dml.DMLReplaceStatement;
import com.alibaba.cobar.server.parser.ast.statement.dml.DMLSelectStatement;
import com.alibaba.cobar.server.parser.ast.statement.dml.DMLSelectUnionStatement;
import com.alibaba.cobar.server.parser.ast.statement.dml.DMLUpdateStatement;
import com.alibaba.cobar.server.parser.ast.statement.extension.ExtDDLCreatePolicy;
import com.alibaba.cobar.server.parser.ast.statement.extension.ExtDDLDropPolicy;
