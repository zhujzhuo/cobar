...
public final class ShowConnectionSQL {
    ...
    public static void execute(ManagerConnection c) {
        ...
        for (NIOProcessor p : CobarContainer.getInstance().getProcessors()) {
    ...
    private static RowDataPacket getRow(FrontendConnection c, String charset) {
        ...
        row.add(LongUtil.toBytes(statistic.getLastReadTime()));
        long rt = statistic.getLastReadTime();
        long wt = statistic.getLastWriteTime();
