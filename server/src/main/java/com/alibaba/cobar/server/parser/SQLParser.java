...
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDALParser;
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDDLParser;
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDMLCallParser;
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDMLDeleteParser;
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDMLInsertParser;
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDMLReplaceParser;
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDMLSelectParser;
import com.alibaba.cobar.server.parser.mysql.syntax.MySQLDMLUpdateParser;
...
public final class SQLParser {
    ...
    private static SQLStatement parse(String sql, MySQLLexer lexer, String charset) throws SQLSyntaxErrorException {
    ...
    public static SQLStatement parse(String sql) throws SQLSyntaxErrorException {
        return parse(sql, new MySQLLexer(sql), MySQLParser.DEFAULT_CHARSET);
    }
