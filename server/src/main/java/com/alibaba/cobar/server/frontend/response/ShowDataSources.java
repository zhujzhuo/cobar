...
import com.alibaba.cobar.server.model.DataSources;
import com.alibaba.cobar.server.model.Instances;
import com.alibaba.cobar.server.model.Machines;
...
public class ShowDataSources {
    ...
    public static void response(ServerConnection c) {
        ...
        DataNodes dataNodes = CobarContainer.getInstance().getConfigModel().getDataNodes();
    ...
    private static RowDataPacket getRow(DataNodes.DataNode node, String charset) {
        ...
        if (ds != null) {
            CobarModel cc = CobarContainer.getInstance().getConfigModel();
