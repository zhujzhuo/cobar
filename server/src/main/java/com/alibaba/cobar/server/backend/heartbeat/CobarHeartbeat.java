...
import com.alibaba.cobar.server.core.statistics.HeartbeatStatistic;
...
public class CobarHeartbeat {
    ...
    public HeartbeatStatistic getRecorder() {
        return recorder;
    }
    ...
    public String lastActiveTime() {
        ...
        long t = Math.max(statistic.getLastReadTime(), statistic.getLastWriteTime());
