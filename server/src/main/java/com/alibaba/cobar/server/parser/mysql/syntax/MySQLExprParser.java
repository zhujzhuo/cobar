...
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.EOF;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.IDENTIFIER;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_AND;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_AS;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_ASC;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_BY;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_COLLATE;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_DESC;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_DISTINCT;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_FROM;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_IN;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_INTEGER;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_LIKE;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_NOT;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_SELECT;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_SEPARATOR;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_THEN;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_USING;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_WHEN;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.KW_WITH;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.LITERAL_CHARS;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.OP_ASSIGN;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.PUNC_COMMA;
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.PUNC_DOT;
...
import static com.alibaba.cobar.server.parser.mysql.MySQLToken.USR_VAR;
...
import com.alibaba.cobar.server.parser.ast.expression.arithmeic.ArithmeticAddExpression;
import com.alibaba.cobar.server.parser.ast.expression.arithmeic.ArithmeticDivideExpression;
import com.alibaba.cobar.server.parser.ast.expression.arithmeic.ArithmeticIntegerDivideExpression;
import com.alibaba.cobar.server.parser.ast.expression.arithmeic.ArithmeticModExpression;
import com.alibaba.cobar.server.parser.ast.expression.arithmeic.ArithmeticMultiplyExpression;
import com.alibaba.cobar.server.parser.ast.expression.arithmeic.ArithmeticSubtractExpression;
import com.alibaba.cobar.server.parser.ast.expression.arithmeic.MinusExpression;
import com.alibaba.cobar.server.parser.ast.expression.bit.BitAndExpression;
import com.alibaba.cobar.server.parser.ast.expression.bit.BitInvertExpression;
import com.alibaba.cobar.server.parser.ast.expression.bit.BitOrExpression;
import com.alibaba.cobar.server.parser.ast.expression.bit.BitShiftExpression;
import com.alibaba.cobar.server.parser.ast.expression.bit.BitXORExpression;
...
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionGreaterThanExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionGreaterThanOrEqualsExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionIsExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionLessOrGreaterThanExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionLessThanExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionLessThanOrEqualsExpression;
import com.alibaba.cobar.server.parser.ast.expression.comparison.ComparisionNotEqualsExpression;
...
import com.alibaba.cobar.server.parser.ast.expression.logical.LogicalNotExpression;
import com.alibaba.cobar.server.parser.ast.expression.logical.LogicalOrExpression;
import com.alibaba.cobar.server.parser.ast.expression.logical.LogicalXORExpression;
import com.alibaba.cobar.server.parser.ast.expression.logical.NegativeValueExpression;
import com.alibaba.cobar.server.parser.ast.expression.misc.AssignmentExpression;
...
import com.alibaba.cobar.server.parser.ast.expression.misc.SubqueryAllExpression;
import com.alibaba.cobar.server.parser.ast.expression.misc.SubqueryAnyExpression;
...
import com.alibaba.cobar.server.parser.ast.expression.primary.function.string.Trim.Direction;
...
import com.alibaba.cobar.server.parser.ast.expression.string.RegexpExpression;
import com.alibaba.cobar.server.parser.ast.expression.string.SoundsLikeExpression;
import com.alibaba.cobar.server.parser.ast.expression.type.CastBinaryExpression;
import com.alibaba.cobar.server.parser.ast.expression.type.CollateExpression;
import com.alibaba.cobar.server.parser.mysql.MySQLFunctionManager;
