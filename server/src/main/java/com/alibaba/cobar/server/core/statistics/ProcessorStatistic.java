 ...
 */
package com.alibaba.cobar.server.core.statistics;

/**
 * @author xianmao.hexm
 */
public class ProcessorStatistic {

    private CommandCount commands;
    private long netInBytes;
    private long netOutBytes;

    public ProcessorStatistic() {
     ...
     */
    public void setCommands(CommandCount commands) {
        this.commands = commands;
    }

    /**
     * @return the netInBytes
     */
